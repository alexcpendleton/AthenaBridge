// Type: cliext.bidirectional_iterator_tag
...
namespace cliext
{
  internal class bidirectional_iterator_tag : forward_iterator_tag
  {
    public bidirectional_iterator_tag(bidirectional_iterator_tag _param1)
    {
    }
