// Type: cliext.random_access_iterator_tag
...
namespace cliext
{
  internal class random_access_iterator_tag : bidirectional_iterator_tag
  {
    public random_access_iterator_tag(random_access_iterator_tag _param1)
    {
    }
